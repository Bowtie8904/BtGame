...
public abstract class LocationTrigger extends GameBody implements Contacter
{
     ...
     *
     * @param scene              The scene that uses this trigger.
     * @param x                  The x position.
     * @param y                  The y position.
     * @param shape              The area of the trigger.
     * @param acceptedCollisions The class types that are allowed to trigger this instance. Note that this trigger uses a
     ...
     *
     * @param repeat true if an object should be able to trigger this instance multiple times by leaving and reentering the
     *               area.
     */
     ...
     */
    @Override
    public synchronized boolean onContactBegin(ContactCollisionData contactCollisionData, Contact contact, CollisionBody body)
    {
     ...
     */
    @Override
    public synchronized void onContactEnd(ContactCollisionData contactCollisionData, Contact contact, CollisionBody body)
    {
        if (this.repeat)
        {
